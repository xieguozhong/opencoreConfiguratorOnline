...
const SYSTEM_TIPS = {
    ...
    Booter:{
        ...
        Quirks:{
            ...
            FixupAppleEfiImages:'NO 修复早期 mac os x 启动 efi 映像中的错误',
    ...
    UEFI:{
        ...
        AppleInput:{
            ...
            PointerDwellDoubleClickTimeout:'0 在 Apple Event 协议的 OpenCore 重新实现中配置指针停留单击单左双击超时，以毫秒为单位。 使用 OEM Apple 实现时无效（请参阅 AppleEvent 设置）',
            PointerDwellRadius:'0 在 Apple Event 协议的 OpenCore 重新实现中，以像素为单位配置指针停留单击容差半径。 使用 OEM Apple 实现时无效（请参阅 AppleEvent 设置）',
        ...
        Quirks:{
            ...
            ShimRetainProtocol:'NO 请求 Linux Shim 为后续图像加载保留已安装的协议',
