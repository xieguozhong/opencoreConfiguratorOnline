...
const GLOBAL_LANG = {
    'zh-CN' : {
		...
		supportversion : '注意: 当前版本保存后的plist文件最高支持官方发布的OpenCore-0.6.5-RELEASE'
    },
    ...
    'en-US' : {
		...
		supportversion : 'Note: The plist file saved in the current version supports up to the officially released OpenCore-0.6.5-RELEASE'
    }
};
