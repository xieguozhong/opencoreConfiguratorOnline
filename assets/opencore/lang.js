...
const GLOBAL_LANG = {
    'zh-CN' : {
		...
		supportversion : '注意: 当前版本保存后的plist文件只适用于官方发布的OpenCore-0.6.4-RELEASE'
    },
    ...
    'en-US' : {
		...
		supportversion : 'Note: The plist file saved in the current version is only applicable to the officially released OpenCore-0.6.4-RELEASE'
    }
};
