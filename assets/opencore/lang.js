...
const GLOBAL_LANG = {
    'zh-CN' : {
        ...
        choose : '打开',
        change : '更换',
        alertfileerror : '只能选择后缀为plist的文件',
    ...
    'en-US' : {
        ...
        choose : 'Open',
        change : 'Change',
        alertfileerror : 'Only files with plist suffix can be selected',
        toNumberError : 'The data in the plastic format was incorrectly entered in the string "{@1}", which may cause the configuration file to be wrong. Please check, if there is any data that is not submitted after the modification, please press the Enter key to submit the modification',
