...
const GLOBAL_LANG = {
    'zh-CN' : {
        ...
        supportversion : '注意: 适配官方发布的OpenCore-0.7.5-RELEASE',
        footermessage:'适配版本: OpenCore-0.7.5-RELEASE'
    },
    ...
    'en-US' : {
        ...
        supportversion : 'Note: The plist file saved in the current version supports up to the officially released OpenCore-0.7.5-RELEASE',
        footermessage:'Maximum support: OpenCore-0.7.5-RELEASE'
    }
};
