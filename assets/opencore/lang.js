...
const GLOBAL_LANG = {
    'zh-CN' : {
        ...
        supportversion : '注意: 最高支持官方发布的OpenCore-0.7.3-RELEASE，从0.7.2升级上来的注意UEFI/Drivers的变化',
        footermessage:'最高支持: OpenCore-0.7.3-RELEASE，从0.7.2升级上来的注意UEFI/Drivers的变化'
    },
    ...
    'en-US' : {
        ...
        supportversion : 'Note: The plist file saved in the current version supports up to the officially released OpenCore-0.7.3-RELEASE',
        footermessage:'Maximum support: OpenCore-0.7.3-RELEASE'
    }
};
